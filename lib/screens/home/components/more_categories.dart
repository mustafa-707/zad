...
class RootCategoriesList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final categoriesProvider = ref.watch(getRootCategoriesFutureProvider);
    final media = MediaQuery.of(context);

    return Scaffold(
      appBar: const SubScreenAppbar(title: 'Main Categories'),
      body: Padding(
